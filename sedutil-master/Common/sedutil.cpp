...
int main(int argc, char * argv[])
{
	...
	case sedutiloption::readDataStore:
		LOG(D) << "testing datastore";
		return d->readDataStore(argv[opts.filename], argv[opts.password]);
		break;
	case sedutiloption::writeDataStore:
		LOG(D) << "writing file to datastore";
		return d->writeDataStore(argv[opts.filename], argv[opts.password]);
    default:
